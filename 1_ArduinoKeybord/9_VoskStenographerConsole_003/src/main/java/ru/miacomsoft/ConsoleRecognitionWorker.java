...
public class ConsoleRecognitionWorker {
    ...
    private String fixRussianEncoding(String text) {
        ...
        try {
            ...
            String utf8Text = new String(cp1251Bytes, java.nio.charset.StandardCharsets.UTF_8);
            if (utf8Text.matches(".*[а-яА-ЯёЁ].*")) {
                return utf8Text;
            }

            byte[] isoBytes = text.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
            String utf8Text2 = new String(isoBytes, java.nio.charset.StandardCharsets.UTF_8);
